...
class fileupload
{
	...
	function fileupload()
		...
		$this->uploadDir=$_SERVER['DOCUMENT_ROOT']."/userfiles/";
		$this->error="";
		$this->mysql=new mysql;
		}

		
	function uploadFile($filepath) // pass the temporary image path
		{
		// getting paths
	...
	function getPhotoById($pid,$size)
	{
		...
		case "3":
		$str=$this->domainPath."userimages/".$data['userid']."/".$data['filename']."_600x450.".$data['ext'];
		break;
